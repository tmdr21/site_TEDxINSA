                    ...
                    <div class="container-fluid object-view object-view-edit">
                        ...
                        <div class="d-sm-flex align-items-center mb-4 row object-header">
                            ...
                            <div class="col-md-7">
                                ...
                                <input id="link" class="form-control" placeholder="Url site web">
                            </div>
                        ...
                        <div class="object-edit-buttons">
                            <button type="button" class="btn btn-secondary" onclick="window.location = 'sponsors_list.php'">Annuler</button>
                            <button type="button" class="btn btn-danger" onclick="createSponsor();">Valider</button>
                        </div>
                    </div>
                    <!-- /.container-fluid -->
